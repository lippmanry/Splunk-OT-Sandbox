...
| asset_tag<br> sensor_id  | String | Hardware identifier  | asset_security_registry.csv (**asset_tag**)<br>factory_maintenance_logs.csv (**asset_tag**)<br>tenable_ot_passive_discovery.csv (**asset_tag**)<br>wind_factory_telemetry.csv (**sensor_id**) |
